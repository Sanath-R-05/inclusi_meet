<div align="center">
  ...
  <h3 align="center">InclusiMeet</h3>
...
Built with the latest Next.js and TypeScript, this project is a video conferencing website 
...
```bash
git clone https://github.com/Sanath-R-05/inclusi_meet.git
cd inclusi_meet
```
